...
//Name: FinishLine.ma
//Last modified: Thu, Apr 10, 2014 08:23:52 PM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -11.182473859835005 19.102943243919345 15.926694431901961 ;
	setAttr ".r" -type "double3" -42.338352731301732 -36.19999999996628 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 27.274457229359061;
...
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.09323766827583313 0.49999992549419403 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 4 ".uvst[0].uvsp[0:3]" -type "float2" 0.18647546 -2.9802322e-008
		 0.18647522 0.99999988 -1.1920929e-007 0.99999988 1.1920929e-007 -2.9802322e-008;
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 4 ".vt[0:3]"  -5 -1.110223e-016 0.9375 5 -1.110223e-016 0.9375
		 -5 1.110223e-016 -0.9375 5 1.110223e-016 -0.9375;
...
createNode file -n "file2";
	setAttr ".ftn" -type "string" "C:/Users/Max/Desktop/finishLine.tga";
